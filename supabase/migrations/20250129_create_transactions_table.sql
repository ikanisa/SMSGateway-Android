...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  sms_message_id UUID NOT NULL REFERENCES momo_sms_raw(id) ON DELETE CASCADE,
...
-- Add comment
COMMENT ON TABLE transactions IS 'Stores MTN MoMo payment transactions parsed from SMS messages. Links to momo_sms_raw table.';
COMMENT ON COLUMN transactions.sms_message_id IS 'Foreign key to momo_sms_raw table - links transaction to source SMS';
