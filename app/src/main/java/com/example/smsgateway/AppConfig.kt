...
object AppConfig {
    // ✅ Provisioned (in-house gateway). Rotate before public release if ever needed.
    ...
    const val DEVICE_ID = "de75ff85a17ee8a2d751a9d591c6680b"
    const val DEVICE_SECRET = "8dc5bb543edaed28b9389f687c2f9ea849702ff94f6b805eae63fbd20edd0bbc"
    const val DEVICE_LABEL = "SMSGateway-1"
}
